/* eslint-disable */
function link(user, context, callback) {
  /**
   * This rule has been automatically generated by Account Link Extension
   */
  ...
  var linkingUrl = configuration.accountLinkExtentionUrl.replace(/\/$/g, '');
  var clientId = configuration.accountLinkClientId;
  var secretId = configuration.accountLinkSecretId;
  var domain = configuration.customDomain || auth0.domain;
