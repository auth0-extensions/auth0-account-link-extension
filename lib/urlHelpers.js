...
function buildBasePath(originalUrl, path) {
...
function getBasePath(req) {
  return buildBasePath(req.originalUrl || '', req.path);
}

function getBaseUrl(req, protocol) {
...
const buildDomainUrl = domain => `https://${domain}/`;

module.exports = {
  getBasePath,
  getBaseUrl,
  getWebtaskUrl,
  createRouteNormalizationRx,
  buildDomainUrl
};
